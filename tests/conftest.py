...
def sample_checkm2_df():
    ...
    return pd.DataFrame({
        ...
        "Genome_Size": [
            5_100_000, 4_900_000, 4_800_000, 5_200_000,
...
def sample_file_list_df():
    ...
    return pd.DataFrame({
        ...
        "filename_in_tar_xz": [
            "SAMN001.fa.gz", "SAMN002.fa.gz", "SAMN003.fa.gz",
            "SAMN005.fa.gz", "SAMN007.fa.gz",
        ],
        "tar_xz": [
            "batch_001.tar.xz", "batch_001.tar.xz", "batch_002.tar.xz",
            "batch_002.tar.xz", "batch_001.tar.xz",
        ],
        "tar_xz_url": [
        ...
        "tar_xz_md5": [
            "abc123", "abc123", "def456", "def456", "abc123",
        ],
    })
...
def sample_mlst_df():
    ...
    return pd.DataFrame({
        "sample": [
            "SAMN001", "SAMN002", "SAMN003", "SAMN005",
            "SAMN006", "SAMN007",
        ],
        "mlst_scheme": [
            "ecoli_achtman_4", "ecoli_achtman_4", "ehormaechei",
            "klebsiella", "saureus", "ecoli_achtman_4",
        ],
        "mlst_st": ["10", "131", "15", "258", "8", "-"],
        "mlst_status": [
            "EXACT", "EXACT", "EXACT", "EXACT", "EXACT", "NOVEL",
        ],
    })
